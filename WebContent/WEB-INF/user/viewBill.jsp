                ...
                <c:choose>
                    <c:when test="${incoming_payment != null}">
                        ...
                        <c:if test="${!incoming_payment.blocked}">
                            <form action="/user/bills/bill" method="post">
                                <tr>
                                    <td>
                                        <button name="number" value="${requestScope.bill.billNumber}b">
                        ...
                        <c:if test="${incoming_payment.blocked}">
                            <form action="/user/bills/bill" method="post">
                                <tr>
                                    <td>
                                        <button
                                                <c:if test="${incoming_payment.needToUnblock}">disabled</c:if> name="number"
                                                value="${requestScope.bill.billNumber}u">
